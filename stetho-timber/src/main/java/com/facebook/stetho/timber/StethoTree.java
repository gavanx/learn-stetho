...
/**
 * Timber tree implementation which forwards logs to the Chrome Dev console. Plant it using {@link Timber#plant(Timber.Tree)}
 * <pre>
 *   {@code
...
public class StethoTree extends Timber.Tree {
    ...
    protected void log(int priority, String tag, String message, Throwable t) {
        ...
        CLog.writeToConsole(logLevel, Console.MessageSource.OTHER, message);
    }
}
