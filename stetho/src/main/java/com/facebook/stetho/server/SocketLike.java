...
/**
 * Utility to allow reading buffered data from a socket and then "unreading" the data and combining it with the original unbuffered stream.  This is
 * useful when handing off from one logical protocol layer to the next, such as when upgrading an HTTP connection to the websocket protocol.
 */
