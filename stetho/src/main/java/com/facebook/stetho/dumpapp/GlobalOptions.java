...
public class GlobalOptions {
    ...
    /**
     * Special option used to inject it into help but is otherwise not processed within the app. Instead, the dumpapp shell script interprets this and
     * figures out which port to send the request to.
     */
