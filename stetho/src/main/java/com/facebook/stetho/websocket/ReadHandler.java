...
class ReadHandler {
    ...
    /**
     * Enter a loop processing incoming frames until orderly shutdown or a socket exception is thrown.  This method returns normally on orderly
     * shutdown, throws otherwise.
     *
