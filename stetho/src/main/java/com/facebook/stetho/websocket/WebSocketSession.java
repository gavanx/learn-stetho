...
/**
 * Binding driver between raw socket I/O and a high-level WebSocket interface.  This implementation is generally very weak and doesn't offer sensible
 * optimizations such as re-used buffers, efficient UTF-8 encoding/decoding, or the full spectrum of features defined in the RFC.
 */
