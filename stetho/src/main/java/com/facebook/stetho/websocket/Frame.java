...
class Frame {
    ...
    private static byte[] encodeLength(long len) {
        if (len <= 125) {
            ...
            return new byte[]{126, (byte) ((len >> 8) & 0xff), (byte) ((len) & 0xff)};
        } else {
            return new byte[]{127, (byte) ((len >> 56) & 0xff), (byte) ((len >> 48) & 0xff), (byte) ((len >> 40) & 0xff), (byte) ((len >> 32) &
                0xff), (byte) ((len >> 24) & 0xff), (byte) ((len >> 16) & 0xff), (byte) ((len >> 8) & 0xff), (byte) ((len) & 0xff)};
        }
    }
