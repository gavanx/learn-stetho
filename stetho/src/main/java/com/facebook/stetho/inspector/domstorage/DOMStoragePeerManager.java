...
public class DOMStoragePeerManager extends ChromePeerManager {
    ...
    private class DevToolsSharedPreferencesListener implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        /**
         * Maintains a copy of the prefs data structure so that we can invoke {@code DOMStorage.domStorageItemUpdated}.  This method requires that we
         * know the old value to perform updates.  Using {@code domStorageItemRemoved}/{@code Added} causes a UI glitch where the item is moved to the
         * end of the list, unfortunately.
         */
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            ...
            if (existedBefore && existsNow) {
                signalItemUpdated(mStorageId, key, SharedPreferencesHelper.valueToString(mCopy.get(key)), SharedPreferencesHelper.valueToString
                    (newValue));
