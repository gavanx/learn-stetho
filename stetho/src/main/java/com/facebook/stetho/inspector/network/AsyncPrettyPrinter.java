...
public interface AsyncPrettyPrinter {
    /**
     * Prints the prettified version of payload to output. This method can block for a certain period of time. Note that Stetho may impose arbitrary
    ...
    /**
     * Specifies the type of pretty printed content. Note that this method is called before the content is actually pretty printed. Stetho uses this
