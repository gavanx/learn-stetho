...
/**
 * An {@link OutputStream} filter which decompresses gzip data before it is written to the specified destination output stream.  This is functionally
 * equivalent to {@link java.util.zip.InflaterOutputStream} but provides gzip header awareness.  The implementation however is very different to avoid
 * actually interpreting the gzip header.
 */
