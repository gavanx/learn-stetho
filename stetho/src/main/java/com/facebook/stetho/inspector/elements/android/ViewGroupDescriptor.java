...
final class ViewGroupDescriptor extends AbstractChainedDescriptor<ViewGroup> {
    ...
    /**
     * This is a cache that maps from a View to the Fragment that contains it. If the View isn't contained by a Fragment, then this maps the View to
     * itself. For Views contained by Fragments, we emit the Fragment instead, and then let the Fragment's descriptor emit the View as its sole child.
     * This allows us to see Fragments in the inspector as part of the UI tree.
     */
