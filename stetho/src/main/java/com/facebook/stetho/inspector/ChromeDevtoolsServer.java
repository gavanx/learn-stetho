...
/**
 * Implements a limited version of the Chrome Debugger WebSocket protocol (using JSON-RPC 2.0). The most up-to-date documentation can be found in the
 * Blink source code: <a href="https://code.google.com/p/chromium/codesearch#chromium/src/third_party/WebKit/Source/devtools/protocol
 * .json&q=protocol.json&sq=package:chromium&type=cs">protocol.json</a>
 */
