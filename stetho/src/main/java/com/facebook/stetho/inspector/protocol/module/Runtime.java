...
public class Runtime implements ChromeDevtoolsDomain {
    ...
    /**
     * @deprecated This was a transitionary API that was replaced by {@link com.facebook.stetho.Stetho.DefaultInspectorModulesBuilder#runtimeRepl}
     */
    ...
    public CallFunctionOnResponse callFunctionOn(JsonRpcPeer peer, JSONObject params) throws JsonRpcException {
        ...
        if (!args.functionDeclaration.startsWith("function protoList(")) {
            throw new JsonRpcException(new JsonRpcError(JsonRpcError.ErrorCode.INTERNAL_ERROR, "Expected protoList, got: " + args
                .functionDeclaration, null /* data */));
        }
     ...
     *
     * <p>Clients inherently leak object references because they can expand any object in the UI at any time.  Grouping references by client allows us
     * to drop them when the client disconnects.
     */
    private static class Session {
        ...
        public Object getObjectOrThrow(String objectId) throws JsonRpcException {
            ...
            if (object == null) {
                throw new JsonRpcException(new JsonRpcError(JsonRpcError.ErrorCode.INVALID_REQUEST, "No object found for " + objectId, null /* data
                 */));
            }
            return object;
        }
        ...
        private GetPropertiesResponse getPropertiesForObject(Object object) {
            ...
            for (Class<?> declaringClass = object.getClass(); declaringClass != null; declaringClass = declaringClass.getSuperclass()) {
                ...
                List<Field> fields = new ArrayList<Field>(Arrays.asList(declaringClass.getDeclaredFields()));
