...
public class ResponseBodyFileManager {
    ...
    /**
     * Associates an asynchronous pretty printer with a response request id The pretty printer will be used to pretty print the response body that has
     * the particular request id
     *
     * @param requestId          Unique identifier for the response as per {@link NetworkEventReporter.InspectorResponse#requestId()}
