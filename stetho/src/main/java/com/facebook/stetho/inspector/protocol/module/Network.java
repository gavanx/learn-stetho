...
public class Network implements ChromeDevtoolsDomain {
    ...
    /**
     * Method that allows callers to provide an {@link AsyncPrettyPrinterInitializer} that is responsible for registering all {@link
     * com.facebook.stetho.inspector.network.AsyncPrettyPrinter}. Note that AsyncPrettyPrinterInitializer cannot be null and can only be set once.
     */
