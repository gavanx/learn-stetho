...
/**
 * Provides sufficient responses to convince Chrome's {@code chrome://inspect/devices} that we're "one of them".  Note that we are being discovered
 * automatically by the name of our socket as defined in {@link LocalSocketHttpServer}.  After discovery, we're required to provide some context on
 * how exactly to display and inspect what we have.
 */
