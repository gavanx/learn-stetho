...
public final class HandlerUtil {
    ...
    /**
     * Enforces that the current thread is the same thread that the {@link Handler} is associated with.
     *
     * @throws IllegalStateException if the current thread is not the same thread that the {@link Handler} is associated with.
     */
    ...
    /**
     * Synchronously executes an {@link UncheckedCallable} on the thread that this Handler is associated with, and returns its result.
     *
