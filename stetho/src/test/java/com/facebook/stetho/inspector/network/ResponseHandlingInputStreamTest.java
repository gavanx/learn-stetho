...
public class ResponseHandlingInputStreamTest {
    ...
    public void setup() {
        ...
        mResponseHandlingInputStream = new ResponseHandlingInputStream(new ByteArrayInputStream(TEST_RESPONSE_BODY), TEST_REQUEST_ID,
            mTestOutputStream, null /* decompressedCounter */, mNetworkPeerManager, new DefaultResponseHandler(mNetworkEventReporter,
            TEST_REQUEST_ID));
    }
    ...
    public void testReadOneByte() throws IOException {
        ...
        CLog.writeToConsole(Mockito.any(ChromePeerManager.class), Mockito.any(Console.MessageLevel.class), Mockito.any(Console.MessageSource.class)
            , Mockito.anyString());
    ...
    public void testSwallowException() throws IOException {
        ...
        ResponseHandlingInputStream responseHandlingInputStream = new ResponseHandlingInputStream(new ByteArrayInputStream(TEST_RESPONSE_BODY),
            TEST_REQUEST_ID, exceptionOutputStream, null /* decompressedCounter */, mNetworkPeerManager, new DefaultResponseHandler
