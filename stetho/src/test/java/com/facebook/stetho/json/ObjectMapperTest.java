...
public class ObjectMapperTest {
    ...
    public void testJsonProperty() throws IOException, JSONException {
        ...
        JsonPropertyString jsonPropertyString = mObjectMapper.convertValue(new JSONObject(expected), JsonPropertyString.class);
    ...
    public void testNestedProperty() throws JSONException {
        ...
        NestedJsonProperty parsed7 = mObjectMapper.convertValue(new JSONObject(expected7), NestedJsonProperty.class);
        assertEquals(njp, parsed7);

        NestedJsonProperty parsed8 = mObjectMapper.convertValue(new JSONObject(expected8), NestedJsonProperty.class);
    ...
    public void testEnumProperty() throws JSONException {
        ...
        JsonPropertyEnum parsed = mObjectMapper.convertValue(new JSONObject(expected), JsonPropertyEnum.class);
    ...
    public void testListString() throws JSONException {
        ...
        JsonPropertyStringList jsonPropertyStringList = mObjectMapper.convertValue(new JSONObject(expected), JsonPropertyStringList.class);
    ...
    public static class NestedJsonProperty {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(child1, ((NestedJsonProperty) o).child1) && Objects.equals(child2, ((NestedJsonProperty) o).child2);
        }
    }
